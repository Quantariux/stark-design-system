...
/*
 * Radix reports state as data-state="checked"; Base UI as data-checked. Every selector
 * that reads it is rewritten to match, because a class that silently never applies leaves
 * the thumb parked in the off position while the control reports itself as on.
 */
function Switch({
  className,
  size = "default",
