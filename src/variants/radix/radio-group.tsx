...
/*
 * Radix folds Radio into the RadioGroup package as Item, and reports selection as
 * data-state="checked" rather than data-checked. Both differences are absorbed here so the
 * exported API and the class names stay the system's own.
 */
