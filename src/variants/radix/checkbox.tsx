...
/*
 * Base UI reports state as data-checked / data-active; Radix as data-state="checked" and
 * data-state="active". Every selector reading it is rewritten, because a Tailwind variant
 * that never matches fails silently -- the control works, and simply never looks selected.
 */
